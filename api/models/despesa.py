...
class Despesa(SQLModel, table=True):
    ...
    tipo_despesa: Optional[str] = Field(max_length=300, description="Tipo da despesa (ex: 'Passagens Aéreas', 'Combustíveis').")
...
>>>>>>> origin/Refatorando:models/despesa.py
