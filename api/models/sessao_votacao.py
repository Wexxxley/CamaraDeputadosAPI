<<<<<<< HEAD:api/models/sessao_votacao.py
...
class SessaoVotacao(SQLModel, table=True):
    ...
    descricao: Optional[str] = Field(description="Descrição da votação.", sa_column=Column(TEXT))
...
>>>>>>> origin/Refatorando:models/sessao_votacao.py
