...
class Despesa(SQLModel, table=True):
    """
    Modelo para registrar as despesas de um Deputado.
    """
    ...
    deputado_id: int = Field(foreign_key="deputado.id", index=True, description="ID do deputado a quem a despesa pertence.")
